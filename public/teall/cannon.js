(function () {
  ...
  this.Int32Array || ((this.Int32Array = Array), (this.Float32Array = Array)),
      ...
      do {
        ...
        if (0 !== a[s + o * s])
          for (r = s + 1; u > r; r++) {
            ...
            h = p;
            do (c = p - h), (a[c + o * r] = s >= c ? 0 : a[c + o * r] - a[c + o * s] * d);
            while (--h);
          }
      } while (--l);
      if (
      ...
      do {
        ...
        if (0 !== o[a + n * a])
          for (s = a + 1; l > s; s++) {
            ...
            r = u;
            do (h = u - r), (o[h + n * s] = a >= h ? 0 : o[h + n * s] - o[h + n * a] * p);
            while (--r);
          }
      } while (--c);
      a = 2;
    ...
    (t.Vec3.prototype.vadd = function (e, i) {
      return i
        ? ((i.x = e.x + this.x), (i.y = e.y + this.y), (i.z = e.z + this.z), void 0)
        : new t.Vec3(this.x + e.x, this.y + e.y, this.z + e.z);
    }),
    (t.Vec3.prototype.vsub = function (e, i) {
      return i
        ? ((i.x = this.x - e.x), (i.y = this.y - e.y), (i.z = this.z - e.z), void 0)
        : new t.Vec3(this.x - e.x, this.y - e.y, this.z - e.z);
    }),
  ...
  (t.Vec3.prototype.tangents = function (t, n) {
    ...
    if (o > 0) {
      ...
      var r = i;
      0.9 > Math.abs(a.x) ? (r.set(1, 0, 0), a.cross(r, t)) : (r.set(0, 1, 0), a.cross(r, t)), a.cross(t, n);
    ...
    (t.Quaternion.prototype.setFromAxisAngle = function (t, e) {
      ...
      (this.x = t.x * i), (this.y = t.y * i), (this.z = t.z * i), (this.w = Math.cos(0.5 * e));
    }),
    ...
    (t.Quaternion.prototype.toEuler = function (t, e) {
      ...
      switch (e) {
        case 'YZX':
          var c = a * s + r * h;
          if (
            (c > 0.499 && ((i = 2 * Math.atan2(a, h)), (n = Math.PI / 2), (o = 0)),
            -0.499 > c && ((i = -2 * Math.atan2(a, h)), (n = -Math.PI / 2), (o = 0)),
            isNaN(i))
          ) {
            var l = a * a,
              u = s * s,
  ...
  (t.Shape.prototype.calculateTransformedInertia = function (e, i, n) {
    ...
    (t.Particle.prototype.sleepTick = function (t) {
      if (this.allowSleep) {
        ...
        0 === e && n > i
          ? ((this.sleepState = 1), (this.timeLastSleepy = t), this.dispatchEvent({ type: 'sleepy' }))
          : 1 === e && i > n
          ? this.wakeUp()
          : 1 === e &&
  ...
  t.SPHSystem.prototype.getNeighbors = function (t, e) {
    for (
      var i = this.particles.length, n = t.id, o = this.smoothingRadius * this.smoothingRadius, a = d, s = 0;
      s !== i;
      s++
    ) {
  ...
  new t.Vec3(),
    (t.Box.prototype.forEachWorldCorner = function (t, e, i) {
      for (
        ...
        x.set(o[a][0], o[a][1], o[a][2]), e.vmult(x, x), t.vadd(x, x), i(x.x, x.y, x.z);
    }),
  ...
  (t.ConvexPolyhedron.prototype.calculateWorldAABB = function (t, e, i, n) {
    ...
    (t.ConvexPolyhedron.prototype.volume = function () {
      return (
        this.boundingSphereRadiusNeedsUpdate && this.computeBoundingSphereRadius(),
    ...
    (t.Cylinder = function (e, i, n, o) {
      ...
      for (var d = 0; a > d; d++) {
        ...
        a - 1 > d
          ...
          : (h.push([0, 1, 2 * d + 1, 2 * d]), r.push(new t.Vec3(u(y), p(y), 0)));
      }
    ...
    (t.Ray = function (e, i) {
      ...
      (this.intersectBody = function (e) {
        return e.shape instanceof t.ConvexPolyhedron
          ...
          ? this.intersectShape(e.shape.convexPolyhedronRepresentation, e.quaternion, e.position, e)
  ...
  (t.Broadphase.prototype.needBroadphaseCollision = function (e, i) {
    return 0 === (e.collisionFilterGroup & i.collisionFilterMask) ||
      ...
      ? !1
      : (0 === (e.motionstate & B) && !e.isSleeping()) || (0 === (i.motionstate & B) && !i.isSleeping())
      ? e.shape || i.shape
  ...
  (t.Broadphase.prototype.doBoundingSphereBroadphase = function (e, i, n, o) {
    ...
    (t.Broadphase.prototype.doBoundingBoxBroadphase = function (e, i, n, o) {
      var a = e.shape,
        s = i.shape;
      if ((e.aabbNeedsUpdate && e.computeAABB(), i.aabbNeedsUpdate && i.computeAABB(), a && s))
  ...
  (t.Broadphase.prototype.makePairsUnique = function (t, e) {
    ...
    (t.NaiveBroadphase.prototype.collisionPairs = function (t, e, i) {
      ...
      for (n = 0; n !== h; n++)
        for (o = 0; o !== n; o++)
          (a = r[n]), (s = r[o]), this.needBroadphaseCollision(a, s) && this.intersectionTest(a, s, e, i);
    }),
  ...
  (t.GSSolver.prototype.solve = function (t, e) {
    ...
    for (var x = 0; x !== d; x++) {
      var g = p[x];
      g.spookParamsNeedsUpdate && (g.updateSpookParams(f), (g.spookParamsNeedsUpdate = !1)),
        (b[x] = 0),
        (w[x] = g.computeB(f)),
        (m[x] = 1 / g.computeC());
    }
  ...
  (t.SplitSolver.prototype.solve = function (e, i) {
    ...
    for (
      var s = H, r = i.bodies, h = this.equations, c = h.length, l = r.length, u = this.subsolver, p = s.length;
      p !== l;
      p++
    )
    ...
    (t.World = function () {
      t.EventTarget.apply(this),
        ...
        (this.defaultContactMaterial = new t.ContactMaterial(this.defaultMaterial, this.defaultMaterial, 0.3, 0)),
        (this.doProfiling = !1),
        (this.profile = {
          solve: 0,
    ...
    (t.World.prototype.add = function (e) {
      (e.id = this.id()),
        ...
        e instanceof t.RigidBody &&
          (e.angularVelocity.copy(e.initAngularVelocity), e.quaternion.copy(e.initQuaternion));
  ...
  (t.World.prototype.step = function (e) {
    ...
    for (var j = 0; j !== P; j++) {
      ...
      if (0 > T) {
        ...
        this.collisionMatrixSet(g, I, 1, !0),
          this.collisionMatrixGet(g, I, !0) !== this.collisionMatrixGet(g, I, !1) &&
            ((Z.with = B),
            (Z.contact = C),
            V.dispatchEvent(Z),
            (Z.with = V),
    ...
    for (g = 0; g !== s; g++) {
      ...
      if (ye.motionstate & ce) {
        ...
        if (
          ...
          (be.y += me.y * ze * e),
          (be.z += me.z * ze * e),
          ye.angularVelocity && ((xe.x += we.x * Ee.x * e), (xe.y += we.y * Ee.y * e), (xe.z += we.z * Ee.z * e)),
          ye.isSleeping() ||
            ((ge.x += be.x * e),
            (ge.y += be.y * e),
            (ge.z += be.z * e),
    ...
    for (
      l && (u.integrate = d() - i), this.time += e, this.stepnumber += 1, this.dispatchEvent(Y), g = 0;
      g !== s;
      g++
    ) {
      var V = r[g],
    ...
    (t.ContactGenerator = function () {
      ...
      function s(t, i, n, o, a, s, r, h, c) {
        ...
        for (
          var u = i.radius, p = !1, d = q, v = j, y = C, f = null, w = 0, b = 0, x = 0, g = null, V = 0, B = l.length;
          V !== B && p === !1;
          V++
        ) {
          var I = E;
        ...
        m.release(H), (H = null);
        for (
          var Z = m.get(), _ = m.get(), D = m.get(), K = m.get(), L = m.get(), J = l.length, X = 0;
          X !== J && !p;
          X++
        )
          for (var G = 0; G !== J && !p; G++)
      ...
      function r(t, i, n, o, s, r, h, c, l) {
        ...
        for (var u = n.faceNormals, p = n.faces, d = n.vertices, v = i.radius, y = 0; y !== d.length; y++) {
          ...
          if ((w.vsub(o, b), v * v > b.norm2())) {
            ...
            var x = e(c, l);
            return (
              b.copy(x.ri), x.ri.normalize(), x.ri.copy(x.ni), x.ri.mult(v, x.ri), w.vsub(s, x.rj), t.push(x), void 0
            );
          }
        }
        ...
        if (a && f) {
          if (a.type === S)
            ...
            switch (f.type) {
              ...
              default:
                console.warn(
                  'Collision between CANNON.Shape.types.CONVEXPOLYHEDRON and ' + f.type + ' not implemented yet.',
                );
            }
        } else
          switch (f.type) {
  ...
  (t.ContactEquation.prototype.addToWlambda = function (t) {
    ...
    a.mult(n * t, r),
      ...
      void 0 !== e.wlambda && (this.biInvInertiaTimesRixn.mult(t, s), e.wlambda.vsub(s, e.wlambda)),
      void 0 !== i.wlambda && (this.bjInvInertiaTimesRjxn.mult(t, s), i.wlambda.vadd(s, i.wlambda));
  }),
    ...
    (t.DistanceConstraint = function (e, i, n, o) {
      ...
      (s.minForce = -o),
        ...
        (this.update = function () {
          i.position.vsub(e.position, s.ni), s.ni.normalize(), s.ni.mult(0.5 * n, s.ri), s.ni.mult(0.5 * -n, s.rj);
        });
    }),
